 ...
 *
 *  This app requires it's parent app and uses the built in virtual thermostat device driver to function.
 *
...
definition(
    ...
    parent: "jeabraham:PID Thermostat"
)
